...
(function($){
    $.fn.scratchie = function(options) {
        // default options
        var settings = {
        	cursor: 'marteau.gif', // mouse cursor image
        	cursorHeight: 100, // mouse cursor image height (px)
        	cursorWidth: 100, // mouse cursor image width (px)
        	target : 'target', // target (prize) img element id
            img : 'MonaLisa.jpg', // target (prize) img source
            imgHeight : 700, // target (prize) img height
            imgWidth : 600, // target (prize) img width
            title : 'Are you feeling lucky today?', // image title/alt attributes
            fillColor : '#cc0000', // scratchcard overlay color
            fillImg : 'mur-en-brique.jpg', // scratchcard overlay image
            fillX : 75, // width of overlay blocks
            fillY : 37, // height of overlay blocks
