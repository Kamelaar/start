...
(function($){
    $.fn.scratchie = function(options) {
        // default options
        var settings = {
        	cursor: 'cursor.svg', // mouse cursor image
        	cursorHeight: 50, // mouse cursor image height (px)
        	cursorWidth: 50, // mouse cursor image width (px)
            ...
            fillX : 100, // width of overlay blocks
            fillY : 50, // height of overlay blocks
